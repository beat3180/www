...
<!--//定数、/var/www/html/../view/templates/head.phpというドキュメントルートを通り、head.phpデータを読み取る-->
  ...
  <title>MY記事一覧</title>
<!--//定数、/assets/css/user_contents.cssというドキュメントルートを通り、index.cssを読み込む-->
<link rel="stylesheet" href="<?php print(STYLESHEET_PATH . 'user_contents.css'); ?>">
  ...
  <div class="album py-5 bg-light">
    ...
    <h1 class="mb-5">MY記事</h1>
      ...
      <?php foreach($contents as $content){ ?>
        <div class="col-md-4">
          <div class="card mb-4 shadow-sm <?php print (is_open($content) ? '' : 'close_contents'); ?>">
